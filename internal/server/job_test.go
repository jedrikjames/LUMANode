...
if [ "$1" = "inspect" ]; then
  case "$3" in
    ...
    *json\ .Mounts*)
      ...
      ;;
    *.HostConfig.NanoCpus*)
      echo "1000000000 536870912 536870912 5g 67108864 json-file 10m 3 non-blocking 4m 0 0 0 0 none none"
      exit 0
      ;;
    *.HostConfig.Privileged*)
      echo "false true 512 none private private private private no true 30 false false false luma-tenant_demo 10000:10000 ALL, no-new-privileges=true,seccomp=lumapanel-default,apparmor=lumapanel-tenant, 1 luma-tenant_demo, none none none none none none none none none none none 0 0 none none none 0 none none 0 0 SIGTERM 11 5"
...
func TestVerifyStartedContainerResourcesRequiresSharedMemorySize(t *testing.T) {
	...
	writeFakeCommand(t, tempDir, "docker", `#!/bin/sh
if [ "$1" = "inspect" ]; then
  echo "1500000000 536870912 536870912 5g 33554432 json-file 10m 3 non-blocking 4m 0 0 0 0 none none"
  exit 0
fi
exit 1
`)
...
func TestVerifyStartedContainerResourcesRequiresLogBackpressurePolicy(t *testing.T) {
	cases := []struct {
		...
		{
			name:   "driver",
			output: "1500000000 536870912 536870912 5g 67108864 local 10m 3 non-blocking 4m 0 0 0 0 none none",
		},
		{
			name:   "max-size",
			output: "1500000000 536870912 536870912 5g 67108864 json-file 100m 3 non-blocking 4m 0 0 0 0 none none",
		},
		{
			name:   "max-file",
			output: "1500000000 536870912 536870912 5g 67108864 json-file 10m 10 non-blocking 4m 0 0 0 0 none none",
		},
		{
			name:   "mode",
			output: "1500000000 536870912 536870912 5g 67108864 json-file 10m 3 blocking 4m 0 0 0 0 none none",
		},
		{
			name:   "max-buffer-size",
			output: "1500000000 536870912 536870912 5g 67108864 json-file 10m 3 non-blocking 32m 0 0 0 0 none none",
		},
	}
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
...
func TestVerifyStartedContainerResourcesRejectsSchedulerOverrides(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			output:   "1500000000 536870912 536870912 5g 67108864 json-file 10m 3 non-blocking 4m 268435456 0 0 0 none none",
			contains: "memory reservation",
		},
		{
			name:     "cpu-shares",
			output:   "1500000000 536870912 536870912 5g 67108864 json-file 10m 3 non-blocking 4m 0 1024 0 0 none none",
			contains: "CPU scheduler overrides",
		},
		{
			name:     "cpu-quota",
			output:   "1500000000 536870912 536870912 5g 67108864 json-file 10m 3 non-blocking 4m 0 0 100000 0 none none",
			contains: "CPU scheduler overrides",
		},
		{
			name:     "cpu-period",
			output:   "1500000000 536870912 536870912 5g 67108864 json-file 10m 3 non-blocking 4m 0 0 0 100000 none none",
			contains: "CPU scheduler overrides",
		},
		{
			name:     "cpuset-cpus",
			output:   "1500000000 536870912 536870912 5g 67108864 json-file 10m 3 non-blocking 4m 0 0 0 0 0-1 none",
			contains: "CPU set restrictions",
		},
		{
			name:     "cpuset-mems",
			output:   "1500000000 536870912 536870912 5g 67108864 json-file 10m 3 non-blocking 4m 0 0 0 0 none 0",
			contains: "CPU set restrictions",
		},
	}
	for _, tt := range cases {
